...
////////////////////////////////////////////////////////////////////////////////////////////////////////
// 新增基于chebyshev基的多项式求值
    CkksCiphertext poly_eval_chebyshev(const CkksCiphertext& x_ct, const std::vector<double>& coeffs, double a, double b, 
                                        uint64_t slots,        // 新增：槽位数
                                        double base_scale      // 新增：基础缩放因子
                                        );
