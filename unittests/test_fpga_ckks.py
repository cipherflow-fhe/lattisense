...
param = Param.create_ckks_fpga_param()
...
class TestTask(unittest.TestCase):
    ...
    def test_ct_pt_mult_accumulate(self, levels=[i for i in range(1, param.max_level + 1)]):
        for lv in levels:
            for m in range(2, 21):
    ...
    # @unittest.skip('')
    def test_seal_rotate_col(self, n_op=4, levels=[param.max_level], steps=[-500, 20, 200, 2000, 4000]):
        def rotate_steps(x: list[DataNode]) -> DataNode:
            y_list = []
            for i in range(len(x_list)):
    ...
    # @unittest.skip('')
    def test_seal_advanced_rotate_col(self, n_op=4, levels=[param.max_level], steps=[-500, 20, 200, 2000, 4000]):
        def rotate_steps(x: list[DataNode]) -> DataNode:
            y_list = []
            for i in range(len(x_list)):
    ...
    # @unittest.skip('')
    def test_cap_3d(self, dim0=1, dim1=1, dim2=1, levels=[i for i in range(1, param.max_level + 1)]):
    ...
    # @unittest.skip('')
    def test_cmc_relin_4d(self, dim0=1, dim1=1, dim2=1, dim3=1, levels=[i for i in range(1, param.max_level + 1)]):
    ...
    # @unittest.skip('')
    def test_cmp_3d(self, dim0=1, dim1=1, dim2=1, levels=[i for i in range(1, param.max_level + 1)]):
    ...
    # @unittest.skip('')
    def test_cmp_4d(self, dim0=1, dim1=1, dim2=1, dim3=1, levels=[i for i in range(1, param.max_level + 1)]):
