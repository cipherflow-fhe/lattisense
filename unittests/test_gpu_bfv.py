...
_BFV_PARAM_TAGS = {
    ...
    id(_p3): f'bfv_param_default_n{_p3.n}_t{hex(_p3.t)[2:]}',
}

BFV_PARAMS = [_p1, _p2, _p3]
...
class TestTask:
    ...
    def test_cap(self, param, lv):
        ...
        task_dir = os.path.join(GPU_OUTPUT_BASE_DIR, param_tag, f'BFV_{N_OP}_cap', f'level_{lv}')
    ...
    def test_cap_ringt(self, param, lv):
        set_fhe_param(param)
        param_tag = _param_tag(param)
        task_dir = os.path.join(GPU_OUTPUT_BASE_DIR, param_tag, f'BFV_{N_OP}_cap_ringt', f'level_{lv}')
        x_list = [BfvCiphertextNode(f'x_{i}', level=lv) for i in range(N_OP)]
    ...
    def test_cac(self, param, lv):
        set_fhe_param(param)
        param_tag = _param_tag(param)
        task_dir = os.path.join(GPU_OUTPUT_BASE_DIR, param_tag, f'BFV_{N_OP}_cac', f'level_{lv}')
        x_list = [BfvCiphertextNode(f'x_{i}', level=lv) for i in range(N_OP)]
    ...
    def test_casc(self, param, lv):
        set_fhe_param(param)
        param_tag = _param_tag(param)
        task_dir = os.path.join(GPU_OUTPUT_BASE_DIR, param_tag, f'BFV_{N_OP}_casc', f'level_{lv}')
        x_list = [BfvCiphertextNode(f'x_{i}', level=lv) for i in range(N_OP)]
    ...
    def test_csp(self, param, lv):
        set_fhe_param(param)
        param_tag = _param_tag(param)
        task_dir = os.path.join(GPU_OUTPUT_BASE_DIR, param_tag, f'BFV_{N_OP}_csp', f'level_{lv}')
        x_list = [BfvCiphertextNode(f'x_{i}', level=lv) for i in range(N_OP)]
        y_list = [BfvPlaintextNode(f'y_{i}', level=lv) for i in range(N_OP)]
    ...
    def test_csp_ringt(self, param, lv):
        set_fhe_param(param)
        param_tag = _param_tag(param)
        task_dir = os.path.join(GPU_OUTPUT_BASE_DIR, param_tag, f'BFV_{N_OP}_csp_ringt', f'level_{lv}')
        x_list = [BfvCiphertextNode(f'x_{i}', level=lv) for i in range(N_OP)]
        y_list = [BfvPlaintextRingtNode(f'y_{i}') for i in range(N_OP)]
        z_list = [sub(x_list[i], y_list[i], f'z_{i}') for i in range(N_OP)]
        process_custom_task(
    ...
    def test_csc(self, param, lv):
        set_fhe_param(param)
        param_tag = _param_tag(param)
        task_dir = os.path.join(GPU_OUTPUT_BASE_DIR, param_tag, f'BFV_{N_OP}_csc', f'level_{lv}')
        x_list = [BfvCiphertextNode(f'x_{i}', level=lv) for i in range(N_OP)]
        y_list = [BfvCiphertextNode(f'y_{i}', level=lv) for i in range(N_OP)]
        z_list = [sub(x_list[i], y_list[i], f'z_{i}') for i in range(N_OP)]
        process_custom_task(
    ...
    def test_cssc(self, param, lv):
        set_fhe_param(param)
        param_tag = _param_tag(param)
        task_dir = os.path.join(GPU_OUTPUT_BASE_DIR, param_tag, f'BFV_{N_OP}_cssc', f'level_{lv}')
        x_list = [BfvCiphertextNode(f'x_{i}', level=lv) for i in range(N_OP)]
    ...
    def test_cneg(self, param, lv):
        set_fhe_param(param)
        param_tag = _param_tag(param)
        task_dir = os.path.join(GPU_OUTPUT_BASE_DIR, param_tag, f'BFV_{N_OP}_cneg', f'level_{lv}')
        x_list = [BfvCiphertextNode(f'x_{i}', level=lv) for i in range(N_OP)]
    ...
    def test_cmp_ringt(self, param, lv):
        set_fhe_param(param)
        param_tag = _param_tag(param)
        task_dir = os.path.join(GPU_OUTPUT_BASE_DIR, param_tag, f'BFV_{N_OP}_cmp_ringt', f'level_{lv}')
        x_list = [BfvCiphertextNode(f'x_{i}', level=lv) for i in range(N_OP)]
        y_list = [BfvPlaintextRingtNode(f'y_{i}') for i in range(N_OP)]
    ...
    def test_cmc(self, param, lv):
        set_fhe_param(param)
        param_tag = _param_tag(param)
        task_dir = os.path.join(GPU_OUTPUT_BASE_DIR, param_tag, f'BFV_{N_OP}_cmc', f'level_{lv}')
        x_list = [BfvCiphertextNode(f'x_{i}', level=lv) for i in range(N_OP)]
        y_list = [BfvCiphertextNode(f'y_{i}', level=lv) for i in range(N_OP)]
        z_list = [mult(x_list[i], y_list[i], f'z_{i}') for i in range(N_OP)]
        process_custom_task(
    ...
    def test_cmc_relin(self, param, lv):
        set_fhe_param(param)
        param_tag = _param_tag(param)
        task_dir = os.path.join(GPU_OUTPUT_BASE_DIR, param_tag, f'BFV_{N_OP}_cmc_relin', f'level_{lv}')
        x_list = [BfvCiphertextNode(f'x_{i}', level=lv) for i in range(N_OP)]
        y_list = [BfvCiphertextNode(f'y_{i}', level=lv) for i in range(N_OP)]
    ...
    def test_cmc_relin_rescale(self, param, lv):
        set_fhe_param(param)
        param_tag = _param_tag(param)
        task_dir = os.path.join(GPU_OUTPUT_BASE_DIR, param_tag, f'BFV_{N_OP}_cmc_relin_rescale', f'level_{lv}')
        x_list = [BfvCiphertextNode(f'x_{i}', level=lv) for i in range(N_OP)]
        y_list = [BfvCiphertextNode(f'y_{i}', level=lv) for i in range(N_OP)]
    ...
    def test_csqr(self, param, lv):
        set_fhe_param(param)
        param_tag = _param_tag(param)
        task_dir = os.path.join(GPU_OUTPUT_BASE_DIR, param_tag, f'BFV_{N_OP}_csqr', f'level_{lv}')
        x_list = [BfvCiphertextNode(f'x_{i}', level=lv) for i in range(N_OP)]
    ...
    def test_csqr_relin(self, param, lv):
        set_fhe_param(param)
        param_tag = _param_tag(param)
        task_dir = os.path.join(GPU_OUTPUT_BASE_DIR, param_tag, f'BFV_{N_OP}_csqr_relin', f'level_{lv}')
        x_list = [BfvCiphertextNode(f'x_{i}', level=lv) for i in range(N_OP)]
    ...
    def test_csqr_relin_rescale(self, param, lv):
        set_fhe_param(param)
        param_tag = _param_tag(param)
        task_dir = os.path.join(GPU_OUTPUT_BASE_DIR, param_tag, f'BFV_{N_OP}_csqr_relin_rescale', f'level_{lv}')
        x_list = [BfvCiphertextNode(f'x_{i}', level=lv) for i in range(N_OP)]
    ...
    def test_rotate_col(self, param, lv, steps=[i + 1 for i in range(8)]):
        ...
        task_dir = os.path.join(
            GPU_OUTPUT_BASE_DIR, param_tag, f'BFV_{N_OP}_rotate_col', f'level_{lv}', f'steps_{steps[0]}_to_{steps[-1]}'
        )
        x_list = [BfvCiphertextNode(f'x_{i}', level=lv) for i in range(N_OP)]
    ...
    def test_advanced_rotate_col(self, param, lv, steps=[-900, 20, 400, 2000, 3009]):
        ...
        task_dir = os.path.join(
            GPU_OUTPUT_BASE_DIR, param_tag, f'BFV_{N_OP}_advanced_rotate_col', f'level_{lv}', f'steps_{steps_str}'
        )
        x_list = [BfvCiphertextNode(f'x_{i}', level=lv) for i in range(N_OP)]
    ...
    def test_rotate_row(self, param, lv):
        set_fhe_param(param)
        param_tag = _param_tag(param)
        task_dir = os.path.join(GPU_OUTPUT_BASE_DIR, param_tag, f'BFV_{N_OP}_rotate_row', f'level_{lv}')
        x_list = [BfvCiphertextNode(f'x_{i}', level=lv) for i in range(N_OP)]
    ...
    def test_rescale(self, param, lv):
        set_fhe_param(param)
        param_tag = _param_tag(param)
        task_dir = os.path.join(GPU_OUTPUT_BASE_DIR, param_tag, f'BFV_{N_OP}_rescale', f'level_{lv}')
        x_list = [BfvCiphertextNode(f'x_{i}', level=lv) for i in range(N_OP)]
    ...
    def test_ctc_ctc_0(self, param, lv):
        ...
        set_fhe_param(param)
        param_tag = _param_tag(param)
        task_dir = os.path.join(GPU_OUTPUT_BASE_DIR, param_tag, 'BFV_ctc_ctc_0', f'level_{lv}')
    ...
    def test_ctc_ctc_1(self, param, lv):
        ...
        set_fhe_param(param)
        param_tag = _param_tag(param)
        task_dir = os.path.join(GPU_OUTPUT_BASE_DIR, param_tag, 'BFV_ctc_ctc_1', f'level_{lv}')
        x_list = [BfvCiphertextNode(f'x_{i}', level=lv) for i in range(4)]
        y_list = [BfvCiphertextNode(f'y_{i}', level=lv) for i in range(4)]
    ...
    def test_1_square_square(self, param, lv):
        ...
        set_fhe_param(param)
        param_tag = _param_tag(param)
        task_dir = os.path.join(GPU_OUTPUT_BASE_DIR, param_tag, 'BFV_1_square_square', f'level_{lv}')
    ...
    def test_ctc_rotate_cac(self, param, lv):
        ...
        set_fhe_param(param)
        param_tag = _param_tag(param)
        task_dir = os.path.join(GPU_OUTPUT_BASE_DIR, param_tag, 'BFV_1_ctc_rotate_cac', f'level_{lv}')
        x_list = [BfvCiphertextNode(f'x_{i}', level=lv) for i in range(1)]
    ...
    def test_double(self, param, lv):
        ...
        set_fhe_param(param)
        param_tag = _param_tag(param)
        task_dir = os.path.join(GPU_OUTPUT_BASE_DIR, param_tag, 'BFV_1_double')
    ...
    def test_braid(self, param, lv):
        ...
        set_fhe_param(param)
        param_tag = _param_tag(param)
        task_dir = os.path.join(GPU_OUTPUT_BASE_DIR, param_tag, 'BFV_braid')
    ...
    def test_poly(self, param, lv):
        ...
        set_fhe_param(param)
        param_tag = _param_tag(param)
        task_dir = os.path.join(GPU_OUTPUT_BASE_DIR, param_tag, 'BFV_n_poly', f'level_{lv}')
        x_list = [BfvCiphertextNode(f'x_{i}', level=lv) for i in range(4)]
    ...
    def test_ct_pt_ringt_mac(self, param, lv):
        ...
        for m in range(44, 51):
            task_dir = os.path.join(GPU_OUTPUT_BASE_DIR, param_tag, 'BFV_cmpac', f'level_{lv}_m_{m}')
    ...
    def test_custom_cmpac(self, param, lv):
        ...
        set_fhe_param(param)
        param_tag = _param_tag(param)
        task_dir = os.path.join(GPU_OUTPUT_BASE_DIR, param_tag, f'BFV_custom_cmpac', f'level_{lv}')
    ...
    def test_custom_compute_at_start(self, param, lv):
        ...
        set_fhe_param(param)
        param_tag = _param_tag(param)
        task_dir = os.path.join(GPU_OUTPUT_BASE_DIR, param_tag, 'BFV_custom_compute_at_start', f'level_{lv}')
        x_list = [BfvCiphertextNode(f'x_{i}', level=lv) for i in range(7)]
        y_list = [CustomDataNode(type='msg', id=f'y_{i}', attributes={'level': 0}) for i in range(7)]
        y_list.append(CustomDataNode(f'y_7'))
    ...
    def test_custom_compute_at_end(self, param, lv):
        ...
        set_fhe_param(param)
        param_tag = _param_tag(param)
        task_dir = os.path.join(GPU_OUTPUT_BASE_DIR, param_tag, f'BFV_custom_compute_at_end', f'level_{lv}')
        x_list = [BfvCiphertextNode(f'x_{i}', level=lv) for i in range(N_OP)]
        y_list = [BfvCiphertextNode(f'y_{i}', level=lv) for i in range(N_OP)]
    ...
    def test_custom_compute_in_middle(self, param, lv):
        ...
        set_fhe_param(param)
        param_tag = _param_tag(param)
        task_dir = os.path.join(GPU_OUTPUT_BASE_DIR, param_tag, f'BFV_custom_compute_in_middle', f'level_{lv}')
        x_list = [BfvCiphertextNode(f'x_{i}', level=lv) for i in range(N_OP)]
        y_list = [BfvCiphertextNode(f'y_{i}', level=lv) for i in range(N_OP)]
    ...
    def test_power_dag(self, param, lv):
        ...
        set_fhe_param(param)
        param_tag = _param_tag(param)
        origin_powerdag_dir = os.path.join(GPU_OUTPUT_BASE_DIR, 'origin_powerdag')
        ...
        max_power = 1137
        src_power_str = '-'.join(str(p) for p in source_power)
        task_dir = os.path.join(GPU_OUTPUT_BASE_DIR, param_tag, 'BFV_power_dag', f'PD-{max_power}#{src_power_str}')
