...
public:
    ...
    explicit IndeterminateProgressBar(Args&&... args)
        ...
        progress_ = 0;
        max_progress_ =
            get_value<details::ProgressBarOption::bar_width>() - get_value<details::ProgressBarOption::lead>().size() +
            get_value<details::ProgressBarOption::start>().size() + get_value<details::ProgressBarOption::end>().size();
    }
...
public:
    void print_progress(bool from_multi_progress = false) {
        ...
        details::IndeterminateProgressScaleWriter writer{os, get_value<details::ProgressBarOption::bar_width>(),
