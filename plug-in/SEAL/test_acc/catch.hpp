...
#    define INTERNAL_CATCH_TYPE_GEN                                                                                    \
        ...
        struct create<Final, TemplateTypeList<Containers...>, TypeList<Types...>> {                                    \
            using type =                                                                                               \
                typename append<Final<>, typename rewrap<TemplateTypeList<Containers>, Types...>::type...>::type;      \
        };                                                                                                             \
...
#    define INTERNAL_CATCH_NTTP_REGISTER0(TestFunc, signature)                                                         \
        template <typename Type> void reg_test(TypeList<Type>, Catch::NameAndTags nameAndTags) {                       \
            Catch::AutoReg(Catch::makeTestInvoker(&TestFunc<Type>), CATCH_INTERNAL_LINEINFO, Catch::StringRef(),       \
                           nameAndTags);                                                                               \
        }
...
#        define INTERNAL_CATCH_TEMPLATE_TEST_CASE_METHOD_NO_REGISTRATION_2(TestNameClass, TestName, ClassName, Name,   \
                                                                           Tags, Signature, ...)                       \
            namespace {                                                                                                \
...
#            define INTERNAL_CATCH_TEMPLATE_TEST_CASE_NO_REGISTRATION(Name, Tags, ...)                                 \
                INTERNAL_CATCH_TEMPLATE_TEST_CASE_NO_REGISTRATION_2(                                                   \
                    ...
                    INTERNAL_CATCH_UNIQUE_NAME(____C_A_T_C_H____T_E_M_P_L_A_T_E____T_E_S_T____F_U_N_C____), Name,      \
...
#            define INTERNAL_CATCH_TEMPLATE_TEST_CASE_METHOD_NO_REGISTRATION(ClassName, Name, Tags, ...)               \
                INTERNAL_CATCH_TEMPLATE_TEST_CASE_METHOD_NO_REGISTRATION_2(                                            \
                    ...
                    INTERNAL_CATCH_UNIQUE_NAME(____C_A_T_C_H____T_E_M_P_L_A_T_E____T_E_S_T____), ClassName, Name,      \
...
#    define INTERNAL_CATCH_TEST_CASE_METHOD(ClassName, ...)                                                            \
        INTERNAL_CATCH_TEST_CASE_METHOD2(INTERNAL_CATCH_UNIQUE_NAME(____C_A_T_C_H____T_E_S_T____), ClassName,          \
                                         __VA_ARGS__)
...
#    define INTERNAL_CATCH_TEMPLATE_PRODUCT_TEST_CASE2(TestName, TestFuncName, Name, Tags, Signature, TmplTypes,       \
        ...
        namespace {                                                                                                    \
            namespace INTERNAL_CATCH_MAKE_NAMESPACE(TestName) {                                                        \
                ...
                template <typename... Types> struct TestName {                                                         \
                    void reg_tests() {                                                                                 \
                        ...
                        constexpr char const* tmpl_types[] = {CATCH_REC_LIST(                                          \
                            INTERNAL_CATCH_STRINGIZE_WITHOUT_PARENS, INTERNAL_CATCH_REMOVE_PARENS(TmplTypes))};        \
                        constexpr char const* types_list[] = {CATCH_REC_LIST(                                          \
                            INTERNAL_CATCH_STRINGIZE_WITHOUT_PARENS, INTERNAL_CATCH_REMOVE_PARENS(TypesList))};        \
                ...
                static int INTERNAL_CATCH_UNIQUE_NAME(globalRegistrar) = []() {                                        \
                    using TestInit =                                                                                   \
                        typename create<TestName, decltype(get_wrapper<INTERNAL_CATCH_REMOVE_PARENS(TmplTypes)>()),    \
            ...
            namespace INTERNAL_CATCH_MAKE_NAMESPACE(TestName) {                                                        \
                ...
                template <typename... Types> struct TestName {                                                         \
                    void reg_tests() {                                                                                 \
                        ...
                        (void)expander{(                                                                               \
                            Catch::AutoReg(                                                                            \
                                Catch::makeTestInvoker(&TestFunc<Types>), CATCH_INTERNAL_LINEINFO, Catch::StringRef(), \
...
#    define INTERNAL_CATCH_TEMPLATE_PRODUCT_TEST_CASE_METHOD_2(TestNameClass, TestName, ClassName, Name, Tags,         \
                                                               Signature, TmplTypes, TypesList)                        \
        CATCH_INTERNAL_START_WARNINGS_SUPPRESSION                                                                      \
        CATCH_INTERNAL_SUPPRESS_GLOBALS_WARNINGS                                                                       \
        CATCH_INTERNAL_SUPPRESS_ZERO_VARIADIC_WARNINGS                                                                 \
        CATCH_INTERNAL_SUPPRESS_UNUSED_TEMPLATE_WARNINGS                                                               \
            ...
            namespace INTERNAL_CATCH_MAKE_NAMESPACE(TestNameClass) {                                                   \
                ...
                template <typename... Types> struct TestNameClass {                                                    \
                    void reg_tests() {                                                                                 \
                        ...
                        (void)expander{                                                                                \
                            (Catch::AutoReg(                                                                           \
                                 Catch::makeTestInvoker(&TestName<Types>::test), CATCH_INTERNAL_LINEINFO, #ClassName,  \
...
#    define INTERNAL_CATCH_TEMPLATE_LIST_TEST_CASE_METHOD(ClassName, Name, Tags, TmplList)                             \
        INTERNAL_CATCH_TEMPLATE_LIST_TEST_CASE_METHOD_2(                                                               \
            INTERNAL_CATCH_UNIQUE_NAME(____C_A_T_C_H____T_E_M_P_L_A_T_E____T_E_S_T____),                               \
            INTERNAL_CATCH_UNIQUE_NAME(____C_A_T_C_H____T_E_M_P_L_A_T_E____T_E_S_T____F_U_N_C____), ClassName, Name,   \
            Tags, TmplList)
...
#    ifdef _MSC_VER
#        pragma warning(push)
#        pragma warning(disable : 4180)  // We attempt to stream a function (address) by const&, which MSVC complains
                                         // about but is harmless
#    endif
...
#        define INTERNAL_CATCH_NO_THROW(macroName, resultDisposition, ...)                                             \
            do {                                                                                                       \
                ...
                } catch (...) { catchAssertionHandler.handleUnexpectedInflightException(); }                           \
                INTERNAL_CATCH_REACT(catchAssertionHandler)                                                            \
            } while (false)
...
#        define INTERNAL_CATCH_THROWS(macroName, resultDisposition, ...)                                               \
            do {                                                                                                       \
                ...
                if (catchAssertionHandler.allowThrows())                                                               \
                    ...
                    } catch (...) { catchAssertionHandler.handleExceptionThrownAsExpected(); }                         \
                else                                                                                                   \
...
#        if defined(__OBJC__)
        ...
        // use of const for Object pointers is very uncommon and under ARC it causes some kind of signature mismatch
    ...
    namespace Detail {
        ...
        template <typename Clock> EnvironmentEstimate<FloatDuration<Clock>> estimate_clock_resolution(int iterations) {
            auto r = run_for_at_least<Clock>(
                         std::chrono::duration_cast<ClockDuration<Clock>>(clock_resolution_estimation_time), iterations,
                         &resolution<Clock>)
                         .result;
            return {
...
public:
    ...
    void
    testGroupEnded(std::string const& testSpec, Totals const& totals, std::size_t groupIndex, std::size_t groupsCount);
...
private:
    ...
    void
    reportExpr(AssertionInfo const& info, ResultWas::OfType resultType, ITransientExpression const* expr, bool negated);
...
clara::Parser makeCommandLineParser(ConfigData& config) {
    ...
    auto const setWaitForKeypress = [&](std::string const& keypress) {
        ...
        if (keypressLc == "never")
            ...
            return ParserResult::runtimeError("keypress argument must be one of: never, start, exit or both. '" +
...
#        ifdef __OBJC__
        ...
        } @catch (NSException* exception) { return Catch::Detail::stringify([exception description]); }
#        else
        ...
        return tryTranslators();
#        endif
    } catch (TestFailureException&) { std::rethrow_exception(std::current_exception()); } catch (std::exception& ex) {
        return ex.what();
    } catch (std::string& msg) { return msg; } catch (const char* msg) {
        return msg;
...
namespace {
    ...
    public:  // IMutableRegistryHub
        ...
        void
        registerTagAlias(std::string const& alias, std::string const& tag, SourceLineInfo const& lineInfo) override {
...
#        if defined(CATCH_INTERNAL_CONFIG_CPP17_UNCAUGHT_EXCEPTIONS) &&                                                \
            !defined(CATCH_CONFIG_NO_CPP17_UNCAUGHT_EXCEPTIONS) && !defined(CATCH_CONFIG_CPP17_UNCAUGHT_EXCEPTIONS)
...
#            define CATCH_REQUIRE_THROWS_AS(expr, exceptionType)                                                       \
                INTERNAL_CATCH_THROWS_AS("CATCH_REQUIRE_THROWS_AS", exceptionType, Catch::ResultDisposition::Normal,   \
                                         expr)
#            define CATCH_REQUIRE_THROWS_WITH(expr, matcher)                                                           \
                INTERNAL_CATCH_THROWS_STR_MATCHES("CATCH_REQUIRE_THROWS_WITH", Catch::ResultDisposition::Normal,       \
                                                  matcher, expr)
#            if !defined(CATCH_CONFIG_DISABLE_MATCHERS)
...
#            define CATCH_FAIL(...)                                                                                    \
                INTERNAL_CATCH_MSG("CATCH_FAIL", Catch::ResultWas::ExplicitFailure, Catch::ResultDisposition::Normal,  \
                                   __VA_ARGS__)
...
#            define CATCH_SUCCEED(...)                                                                                 \
                INTERNAL_CATCH_MSG("CATCH_SUCCEED", Catch::ResultWas::Ok, Catch::ResultDisposition::ContinueOnFailure, \
                                   __VA_ARGS__)
...
#            define REQUIRE_THROWS_WITH(expr, matcher)                                                                 \
                INTERNAL_CATCH_THROWS_STR_MATCHES("REQUIRE_THROWS_WITH", Catch::ResultDisposition::Normal, matcher,    \
                                                  expr)
#            if !defined(CATCH_CONFIG_DISABLE_MATCHERS)
...
#            define FAIL(...)                                                                                          \
                INTERNAL_CATCH_MSG("FAIL", Catch::ResultWas::ExplicitFailure, Catch::ResultDisposition::Normal,        \
                                   __VA_ARGS__)
#            define FAIL_CHECK(...)                                                                                    \
...
#        define CATCH_TRANSLATE_EXCEPTION(signature)                                                                   \
            INTERNAL_CATCH_TRANSLATE_EXCEPTION_NO_REG(INTERNAL_CATCH_UNIQUE_NAME(catch_internal_ExceptionTranslator),  \
                                                      signature)
